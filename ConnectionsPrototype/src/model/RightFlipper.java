...
public class RightFlipper {
	...
	public Circle getGaps(int i) {
		ArrayList<Circle> corners = new ArrayList<Circle>();

		Circle gap1 = new Circle(xpos + 10, ypos + 5, 0);
		Circle gap2 = new Circle(xpos +10, ypos + height - 5, 0);
		Circle gap3 = new Circle(xpos, ypos + 5, 0);
		Circle gap4 = new Circle(xpos, ypos + height - 5, 0);
