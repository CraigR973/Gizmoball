...
//}
	...
	public void save(){
		savefile.save(triangles, squares, circles, leftFlippers, rightFlippers, absorbers, balls);
	}
	...
	public void load()
	{
		...
		this.setChanged();
		this.notifyObservers();
		triangles = loadfile.getTriangle();
		squares = loadfile.getSquare();
		circles = loadfile.getCircle();
		leftFlippers = loadfile.getLFlipper();
		rightFlippers = loadfile.getRFlipper();
		absorbers = loadfile.getAbsorber();
		balls = loadfile.getBall();
	}
