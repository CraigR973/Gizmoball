...
public class Model1 extends Observable{
	...
	public Model1() {
		...
		ball = new Ball1(400, 280, 300, 300);
		absorber = new Absorber(500,25,0,475);
		tri = new Triangle(480,0,20,20);
		tri1 = new Triangle(295,185,20,20);
		sq = new Square (20, 20, 270, 270);
		cir = new Circle1(200, 10, 200, 200);
	}
	...
	public void moveBall() {
		...
		if (ball != null && !ball.stopped()) {
			...
			if(ball.getExactX() > 500 || ball.getExactY() > 500){
