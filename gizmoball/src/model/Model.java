...
//	}
					...
					if(giz == 'S')
					{
						...
						while(found != true)
						{
							for(int index = 0; index<squares.size(); index++)
							{
								SquareGizmo s = squares.get(index);
								String sName = s.getName();
								double nvalue1 = s.getXPos() / 20;
								double nvalue2 = s.getYPos() / 20;
								if(sName.equals(name))
								{
									deleteGizmo(name, "square", nvalue1, nvalue2);
									found = true;
								}
							}
						}
					...
					if(giz == 'A')
					{
						...
						while(found != true)
						{
							for(int index = 0; index<abs.size(); index++)
							{
								Absorber a = abs.get(index);
								String aName = a.getName();
								double nvalue1 = a.getXPos() / 20;
								double nvalue2 = a.getYPos() / 20;
								if(aName.equals(name))
								{
									deleteGizmo(name, "absorber", nvalue1, nvalue2);
									found = true;
								}
							}
						}
					...
					if(giz == 'C')
					{
						...
						while(found != true)
						{
							for(int index = 0; index<balls.size(); index++)
							{
								...
								double nvalue1 = c.getExactX() / 20;
								double nvalue2 = c.getExactY() / 20;
								if(cName.equals(name))
								{
									deleteGizmo(name, "circle", nvalue1, nvalue2);
									found = true;
								}
							}
						}
					...
					if(giz == 'L')
					{
						...
						while(found != true)
						{
							for(int index = 0; index<leftFlippers.size(); index++)
							{
								LeftFlipper lf = leftFlippers.get(index);
								String lfName = lf.getName();
								double nvalue1 = lf.getXPos() / 20;
								double nvalue2 = lf.getYPos() / 20;
								if(lfName.equals(name))
								{
									deleteGizmo(name, "leftflipper", nvalue1, nvalue2);
									found = true;
								}
							}
						}
					...
					if(giz == 'R')
					{
						...
						while(found != true)
						{
							for(int index = 0; index<rightFlippers.size(); index++)
							{
								RightFlipper rf = rightFlippers.get(index);
								String rfName = rf.getName();
								double nvalue1 = rf.getXPos() / 20;
								double nvalue2 = rf.getYPos() / 20;
								if(rfName.equals(name))
								{
									deleteGizmo(name, "rightflippers", nvalue1, nvalue2);
									found = true;
								}
							}
						}
					...
					if(giz == 'T')
					{
						...
						while(found != true)
						{
							for(int index = 0; index<tris.size(); index++)
							{
								TriangleGizmo t = tris.get(index);
								String tName = t.getName();
								double nvalue1 = t.getXpos1() / 20;
								double nvalue2 = t.getYpos1() / 20;
								if(tName.equals(name))
								{
									deleteGizmo(name, "triangle", nvalue1, nvalue2);
									found = true;
								}
							}
						}
					...
					if(giz == 'B')
					{
						...
						while(found != true)
						{
							for(int index = 0; index<balls.size(); index++)
							{
								...
								System.out.println("BALL NAME: " + bName);
								System.out.println("ball n: " + b.getName());
								double nvalue1 = b.getExactX() / 20;
								double nvalue2 = b.getExactY() / 20;
	...
	public void deleteGizmo(String name, String gizmo, double nvalue1, double nvalue2)
	{
		if(gizmo.equals("square"))
		{
			for(int i = 0; i<squares.size(); i++)
			{
				...
				{
					deleteGizmo((int)nvalue1, (int)nvalue2);
				}
			}
		}
	...
	public void flipLeftFlippers(){
		...
		leftFlippers.get(1).rotateLines();
	...
	public void flipRightFlippers(){
		rightFlippers.get(0).rotateLines();
		rightFlippers.get(1).rotateLines();
	...
	public void unflipLeftFlippers(){
		...
		leftFlippers.get(1).unrotateLines();
		this.setChanged();
		this.notifyObservers();
	}
	
	public void unflipRightFlippers(){
		rightFlippers.get(0).unrotateLines();
		rightFlippers.get(1).unrotateLines();
		this.setChanged();
		this.notifyObservers();
	}
