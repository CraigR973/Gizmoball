...
public class GizmosTest {
	...
	public void deleteAbs1() {
		model.addAbsorberGizmo(0);
		model.addAbsorberGizmo(1);
		assertEquals(model.getAbs().size(),2);
		model.deleteGizmo(1,19);
		assertEquals(model.getAbs().size(),2);
	}
	...
	public void checkLoadingFile() {
		assertEquals(model.getCircles().size(),0);
		model.load();
		assertEquals(model.getCircles().size(),12);
	}
...
//	@Test
//	public void testSetGrav(){
//		pl.setGrav(40);
//		assertEquals(pl.getGrav(), 40);
//	}
//	
//	@Test
